<?php
/**
 * Toggle That doesn't close
 *
 */
global $my_toggle_shortcode_count;
$my_toggle_shortcode_count = 0;

global $my_global_var;
$my_global_var = rand();
if (!function_exists('my_display_shortcode_toggle')) {
	function my_display_shortcode_toggle( $atts, $content = null, $shortcodename = '' ) {
		global $my_global_var, $post, $my_toggle_shortcode_count;
...
if (!function_exists('my_display_shortcode_toggles')) {
	function my_display_shortcode_toggles( $atts, $content = null, $shortcodename = '' ){
		// wordpress function
		global $my_toggle_shortcode_count,$post,$my_global_var;
